    ...
    return (
        <nav className="flex items-center justify-between px-3 sm:px-5 lg:px-10 py-6 sm:py-8 w-full text-white relative z-50">
            ...
            <div className="hidden sm:flex gap-4 lg:gap-6 items-center justify-center">
                <a
                    href="#about"
                    className="relative font-sfMono text-lightest-slate text-greenn hover:text-green text-xs transition-colors duration-300"
                >
            ...
            >
                <span
                    className={`w-6 h-0.5 bg-lightest-slate transition-all duration-300 ${isOpen ? "rotate-45 translate-y-2" : ""
                        }`}
                ></span>
